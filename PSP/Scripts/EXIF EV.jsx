...
/* -----------------------------------------  Data Stamp  format ----------------------------------------------------------------------- */
		...
		text_layer.textItem.contents =  "Bosque Guajira, "   + Notice  //+ docName + 
		+ "\r"  + phoTime 					//+ Artist
		+ "\r" + expTime + Fstop + focLength //+ flshMode + gps 
		+ "\r"+ expPgm 
		+ "\r" +ISO + ev 				//+ expCmp //+ mtrMode 
		+ "\r" +wbMode ; 				 //+ expPgm + expCmp + mtrMode 
		 //+ Model  + lens + maxF 
		if (app.activeDocument.info.instructions == "" ) {
			//app.activeDocument.info.instructions = "Bosque Guajira" + "Copyright \u00A9 " + Biz + " " cpyrt  //+ docName +
		      app.activeDocument.info.instructions = "Picture  " + docName + "  Copyright \u00A9 " + Biz + " " + cpyrt
			+ "\r" + phoTime //+ Artist 
			+ "\r" + wbMode + expPgm //+ expCmp //+ mtrMode 
			+ "\r" + expTime + Fstop + focLength //+ flshMode + gps
			+ "\r" + ISO + ev;   //+ expPgm + expCmp + mtrMode 
			//+ Model  + lens + maxF 
		}
